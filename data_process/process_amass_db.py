...
if __name__ == "__main__":
    ...
    smpl_parser_n = SMPL_Parser(model_path="dataset/smpl/smpl", gender="neutral", use_pca=False, create_transl=False)
    smpl_parser_m = SMPL_Parser(model_path="dataset/smpl/smpl", gender="male", use_pca=False, create_transl=False)
    smpl_parser_f = SMPL_Parser(model_path="dataset/smpl/smpl", gender="female", use_pca=False, create_transl=False)
